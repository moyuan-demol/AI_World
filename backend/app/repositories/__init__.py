...
_EXPORTS: dict[str, str] = {
    ...
    "CharacterKnowledgeRepository": "app.repositories.character_knowledge_repository",
    "CharacterRepository": "app.repositories.character_repository",
    "ConversationRepository": "app.repositories.chat_repository",
    "MessageRepository": "app.repositories.chat_repository",
    "DocumentRepository": "app.repositories.document_repository",
    "KnowledgeRepository": "app.repositories.knowledge_repository",
    "MemoryRepository": "app.repositories.memory_repository",
    "UsageRepository": "app.repositories.usage_repository",

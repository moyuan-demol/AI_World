...
_EXPORTS: dict[str, str] = {
    "AIUnavailableError": "app.core.errors",
    "NotFoundError": "app.core.errors",
    "PermissionDeniedError": "app.core.errors",
    "ServiceError": "app.core.errors",
    "ValidationError": "app.core.errors",

...
_EXPORTS: dict[str, str] = {
    "AgentSpec": "app.schemas.roundtable",
    "CharacterCreate": "app.schemas.character",
    "CharacterOut": "app.schemas.character",
    "CharacterUpdate": "app.schemas.character",
    "ChatRequest": "app.schemas.chat",
    "ChatResponse": "app.schemas.chat",
    "ConversationOut": "app.schemas.chat",
    "DocumentOut": "app.schemas.knowledge",
    "KnowledgeCreate": "app.schemas.knowledge",
    "KnowledgeOut": "app.schemas.knowledge",
    "MessageOut": "app.schemas.chat",
    "ORMModel": "app.schemas.common",
    "RoundtableAgentResult": "app.schemas.roundtable",
    "RoundtableRequest": "app.schemas.roundtable",
    "RoundtableResponse": "app.schemas.roundtable",
    "SourceOut": "app.schemas.chat",
    "TokenOut": "app.schemas.user",
    "UploadResult": "app.schemas.knowledge",
    "UserCreate": "app.schemas.user",
    "UserLogin": "app.schemas.user",
    "UserOut": "app.schemas.user",
}

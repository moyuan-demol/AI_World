"""ORM 模型包：惰性导出（表注册见 app/database/init_db.py 的显式导入）。"""
...
_EXPORTS: dict[str, str] = {
    ...
    "CharacterKnowledge": "app.models.character_knowledge",
    "Conversation": "app.models.chat",
    "Document": "app.models.document",
    "KnowledgeBase": "app.models.knowledge",
    "Memory": "app.models.memory",
    "Message": "app.models.chat",
    "UsageLog": "app.models.usage_log",
